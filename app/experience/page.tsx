...
const experiences = [
  {
    ...
    points: [
      ...
      "Designed, created, and optimized REST APIs for production services",
      "Deployed and maintained workloads on AWS with CI/CD pipelines",
      "Built Microsoft 365 workspace add-ins for in-product integrations",
      "Created Claude-based agents and production prompt workflows for AI features",
      "Implemented Excel generation from JSON data using third-party libraries",
    ],
    tags: ["React", "Django", "Python", "REST APIs", "AWS", "CI/CD", "Claude", "Prompt Engineering", "Microsoft 365"],
  },
  {

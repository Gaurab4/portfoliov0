...
const skillCategories = [
  ...
  { title: "BACKEND & APIs", skills: [{ name: "REST APIs", level: 90 }, { name: "Django", level: 85 }, { name: "Node.js", level: 90 }, { name: "Express", level: 88 }, { name: "PostgreSQL", level: 80 }] },
  { title: "CLOUD & DEVOPS", skills: [{ name: "AWS", level: 85 }, { name: "CI/CD Pipelines", level: 84 }, { name: "Docker", level: 88 }, { name: "EC2", level: 84 }, { name: "Amazon RDS", level: 83 }, { name: "Kubernetes", level: 80 }] },
  { title: "AI & PLATFORMS", skills: [{ name: "Claude Agents", level: 86 }, { name: "Prompt Engineering", level: 88 }, { name: "Microsoft 365 Add-ins", level: 82 }, { name: "Gemini API", level: 80 }] },
];

const fullStack = ["JavaScript", "Python", "React.js", "Next.js", "Django", "Node.js", "REST APIs", "PostgreSQL", "AWS", "CI/CD", "Docker", "Kubernetes", "Claude Agents", "Prompt Engineering", "Microsoft 365 Add-ins", "Git"];
...
export default function Home() {
  ...
  return (
    <div className="relative bg-zinc-50">
      ...
      {/* Hero + About */}
      <section id="hero" className="relative z-10 flex min-h-screen flex-col scroll-mt-20 pt-16 bg-gradient-to-br from-zinc-950 via-zinc-900 to-emerald-950">
        <div className="mx-auto flex w-full max-w-7xl flex-1 items-center px-6 py-12 lg:py-16">
          <div className="grid w-full items-center gap-10 lg:grid-cols-[minmax(0,1.85fr)_minmax(0,3.15fr)] lg:gap-16 xl:gap-24">
            <div className="text-center lg:text-left">
              <p className="mb-3 text-xs font-medium uppercase tracking-[0.2em] text-emerald-400">Full Stack Software Engineer</p>
              <h1 className="mb-3 text-5xl font-bold leading-[0.95] tracking-tight text-white sm:text-6xl md:text-7xl lg:text-8xl">Gaurab</h1>
              <p key={roleIndex} className="mb-6 min-h-[1.75rem] text-lg text-emerald-300 animate-fade-in">{roleLabels[roleIndex]}</p>
              <p className="mx-auto max-w-xl text-base leading-relaxed text-zinc-300 lg:mx-0">
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
                ...
                <Link href="/#contact" className="inline-flex h-12 items-center justify-center rounded-lg border border-emerald-500/60 bg-transparent px-6 text-sm font-semibold text-white transition-colors hover:bg-emerald-500/10">Get In Touch</Link>
              </div>
              <div className="mt-8 flex justify-center gap-4 lg:justify-start">
          <a href="https://github.com/Gaurab4" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-lg border border-emerald-500/40 bg-zinc-900/60 text-emerald-400 transition-colors hover:border-emerald-400 hover:text-emerald-300" aria-label="GitHub">
          ...
          <a href="https://www.linkedin.com/in/gaurab-t/" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-lg border border-emerald-500/40 bg-zinc-900/60 text-emerald-400 transition-colors hover:border-emerald-400 hover:text-emerald-300" aria-label="LinkedIn">
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
          </a>
          <a href="https://leetcode.com/u/thgemma/" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-lg border border-emerald-500/40 bg-zinc-900/60 text-emerald-400 transition-colors hover:border-emerald-400 hover:text-emerald-300" aria-label="LeetCode">
            ...
            <div id="about" className="scroll-mt-28 lg:pl-6 xl:pl-10">
              <p className="text-xs font-medium uppercase tracking-[0.2em] text-emerald-400 mb-2">01. ABOUT ME</p>
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-5">Crafting Digital Experiences</h2>
              <div className="space-y-4 text-base leading-relaxed text-zinc-300 mb-6">
              ...
              <div className="grid w-full sm:grid-cols-2 gap-4">
                {features.map((f) => (
                  <div key={f.title} className="flex min-h-[5.5rem] items-center gap-4 rounded-lg border border-emerald-800/40 bg-zinc-900/50 p-5 transition-all duration-200 hover:border-emerald-500/50 hover:bg-zinc-900/80 hover:shadow-sm">
                    <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg border border-emerald-800/50 bg-emerald-950/50 text-emerald-400">
        ...
        <div className="flex justify-center pb-8">
          <a href="#projects" className="animate-bounce text-emerald-400 hover:text-emerald-600" aria-label="Scroll to projects">
      ...
      {/* Projects */}
      <section id="projects" className="min-h-screen pt-24 pb-12 bg-zinc-50 scroll-mt-20">
        <div className="relative z-10 mx-auto max-w-6xl px-6">
          <p className="text-xs font-medium uppercase tracking-[0.2em] text-emerald-600 mb-2">02. PROJECTS</p>
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-zinc-950 mb-8">Recent Work</h2>
          <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      {p.tags.slice(0, 3).map((tag) => (
                        <span key={tag} className="text-xs px-2 py-0.5 rounded border border-zinc-200/80 bg-zinc-100/80 text-zinc-600">
                          {tag}
                        </span>
                      ))}
                      {p.tags.length > 3 && <span className="text-xs text-zinc-500">+{p.tags.length - 3}</span>}
                    </div>
                  </button>
                ))}
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-4 items-stretch min-h-[300px] md:min-h-[340px]">
              ...
              <div className="flex flex-col rounded-lg bg-zinc-100/60 p-5 border border-zinc-200/60 min-h-[260px] md:min-h-0">
                ...
                <div className="flex flex-wrap gap-2 mt-auto">{selectedProject.tags.map((tag) => <span key={tag} className="text-xs px-2 py-1 rounded border border-zinc-200/80 bg-zinc-100/80 text-zinc-600">{tag}</span>)}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Experience */}
      <section id="experience" className="min-h-screen pt-24 pb-12 bg-zinc-900 scroll-mt-20">
        <div className="relative z-10 mx-auto max-w-6xl px-6">
          <p className="text-xs font-medium uppercase tracking-[0.2em] text-emerald-400 mb-2">03. EXPERIENCE</p>
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-12">Where I&apos;ve Worked</h2>
          <div className="relative">
            <div className="absolute left-0 top-0 bottom-0 w-px bg-emerald-800/50" />
            <div className="space-y-8">
              {experiences.map((exp) => (
                <div key={`${exp.company}-${exp.title}-${exp.period}`} className="relative flex gap-6 pl-6">
                  <div className="absolute left-0 top-2 w-3 h-3 rounded-full bg-emerald-500 -translate-x-[5px]" />
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-2 mb-1">
                      <span className="text-sm text-zinc-400">{exp.period}</span>
                      <span className="text-xs px-2 py-0.5 rounded-full bg-emerald-950 text-emerald-300 border border-emerald-800/50">{exp.type}</span>
                    ...
                    {"points" in exp && exp.points ? (
                      <ul className="text-zinc-400 leading-relaxed mt-2 mb-3 space-y-1 list-disc list-inside">
                        {exp.points.map((point: string, j: number) => <li key={j}>{point}</li>)}
                      </ul>
                    ) : (
                      <p className="text-zinc-400 leading-relaxed mt-2 mb-3">
                        {"description" in exp ? (exp as { description: string }).description : ""}
                      </p>
                    )}
                    <div className="flex flex-wrap gap-2">{exp.tags.map((tag) => <span key={tag} className="text-xs px-2 py-0.5 rounded bg-zinc-800 text-emerald-300 border border-emerald-900/50">{tag}</span>)}</div>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* Skills */}
      <section id="skills" className="min-h-screen pt-24 pb-12 bg-zinc-50 scroll-mt-20">
        <div className="relative z-10 mx-auto max-w-6xl px-6">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[90rem] px-6 sm:px-8 lg:px-12">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 lg:gap-8 mb-12">
            {skillCategories.map((cat) => (
              <div key={cat.title} className="rounded-lg bg-zinc-100/70 p-6 sm:p-7 shadow-sm border border-zinc-200/50 min-w-0">
                ...
                <div className="space-y-4">{cat.skills.map((s) => (
                  <div key={s.name}>
                    ...
                    <div className="h-2 rounded-full bg-emerald-100 overflow-hidden"><div className="h-full rounded-full bg-emerald-600" style={{ width: `${s.level}%` }} /></div>
                  </div>
                ))}</div>
              </div>
            ))}
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6">
          ...
          <div className="flex flex-wrap justify-center gap-2">{fullStack.map((tech) => <span key={tech} className="px-3 py-1.5 rounded bg-zinc-100/70 border border-zinc-200/50 text-sm text-zinc-700">{tech}</span>)}</div>
        </div>
      </section>

      {/* Blogs */}
      <section id="blogs" className="min-h-screen flex flex-col justify-center py-24 bg-zinc-100/70 scroll-mt-20">
      ...
      {/* Contact */}
      <section id="contact" className="min-h-screen flex flex-col justify-center pt-24 pb-12 bg-zinc-950 scroll-mt-20">
        <div className="relative z-10 mx-auto w-full max-w-4xl px-6 text-center">
          <p className="text-xs font-medium uppercase tracking-[0.2em] text-emerald-400 mb-2">06. CONTACT</p>
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-4">Let&apos;s Build Something Together</h2>
          <p className="text-zinc-400 mb-10 mx-auto max-w-xl">Reach out for collaborations, opportunities, or project discussions.</p>
          <div className="mx-auto grid w-full max-w-3xl gap-4 sm:grid-cols-3">
            {contactInfo.map((item) => {
              ...
              const cardClass = "rounded-lg bg-zinc-900 p-5 border border-emerald-900/50 hover:border-emerald-500/50 transition-colors h-full";
          ...
          <p className="text-sm text-zinc-500 pt-8">I typically respond within <span className="font-semibold text-emerald-400">24 hours</span>.</p>
        </div>
      </section>

      <footer className="relative z-10 border-t border-emerald-900/50 py-4 text-center text-sm text-emerald-500/80 bg-zinc-950">
